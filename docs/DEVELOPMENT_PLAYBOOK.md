...
**Next action:** Complete the remaining S18 operator gates: configure and verify reset-email delivery, validate signed store candidates in clean profiles, complete store submission, and record operator sign-off.
